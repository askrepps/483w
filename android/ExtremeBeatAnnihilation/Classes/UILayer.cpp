...
void UILayer::SetUpSinglePlayer(CCSize size)
{
	...
	m_scoreLabel = CCLabelTTF::create(CCString::createWithFormat("%d", Player_One_Score)->getCString(), FONT_STYLE, Font_Size_Default);
...
void UILayer::SetUpMultiPlayer(CCSize size)
{
	...
	m_p2scoreLabel = CCLabelTTF::create(CCString::createWithFormat("%d", Player_Two_Score)->getCString(), FONT_STYLE, Font_Size_Default);
